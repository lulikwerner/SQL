...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_after_creation_comments` AFTER INSERT ON `billionaires` FOR EACH ROW INSERT INTO updated_fields VALUES 
	(NEW.id,
	NEW.id_location,
	NEW.placement,
	NEW.fullname,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_before_update_comments` BEFORE UPDATE ON `billionaires` FOR EACH ROW INSERT INTO updated_fields(
    id_location,
    placement,
    fullname,
    firstName,
...
INSERT INTO `businesses` VALUES (1,1,'LVMH Moet Hennessy Louis Vuitton','Fashion & Retail','Fashion & Retail','Chairman and CEO'),(2,2,'Tesla','Automotive','Automotive','CEO'),(3,3,'Amazon','Technology','Technology','Chairman and Founder'),(4,4,'Oracle','Technology','Technology','CTO and Founder'),(5,5,'Berkshire Hathaway Inc (ClA)','Finance & Investments','Finance & Investments','CEO'),(6,6,'Bill & Melinda Gates Foundation','Technology','Technology','Cochair'),(7,7,'Bloomberg','Media & Entertainment','Media & Entertainment','CEO'),(8,8,'America Movil','Telecom','Telecom','Honorary Chairman'),(9,9,'Reliance Industries','Diversified','Diversified','Founder and Chairman'),(10,10,'Los Angeles Clippers','Technology','Technology','Owner'),(11,11,'','Fashion & Retail','Fashion & Retail',''),(12,12,'Alphabet','Technology','Technology','Cofounder and board member'),(13,13,'','Fashion & Retail','Fashion & Retail',''),(14,14,'Alphabet','Technology','Technology','Cofounder and board member'),(15,15,'','Food & Beverage','Food & Beverage',''),(16,16,'Meta Platforms','Technology','Technology','Cofounder'),(17,17,'Koch Industries','Diversified','Diversified','Chairman and CEO'),(18,18,'','Diversified','Diversified',''),(19,19,'Arvest Bank Group','Fashion & Retail','Fashion & Retail','Chairman and CEO'),(20,20,'Walmart','Fashion & Retail','Fashion & Retail','Director'),(21,21,'Crystal Bridges Museum of American Art','Fashion & Retail','Fashion & Retail','Philanthropist'),(22,22,'Thomson Reuters Corporation','Media & Entertainment','Media & Entertainment','Chairman'),(23,23,'Dell Inc','Technology','Technology','Chairman and CEO'),(24,24,'','Diversified','Diversified',''),(26,1,'LVMH Moet Hennessy Louis Vuitton','Fashion & Retail','Fashion & Retail','Chairman and CEO'),(27,2,'Tesla','Automotive','Automotive','CEO'),(28,3,'Amazon','Technology','Technology','Chairman and Founder'),(29,4,'Oracle','Technology','Technology','CTO and Founder'),(30,5,'Berkshire Hathaway Inc (ClA)','Finance & Investments','Finance & Investments','CEO'),(31,6,'Bill & Melinda Gates Foundation','Technology','Technology','Cochair'),(32,7,'Bloomberg','Media & Entertainment','Media & Entertainment','CEO'),(33,8,'America Movil','Telecom','Telecom','Honorary Chairman'),(34,9,'Reliance Industries','Diversified','Diversified','Founder and Chairman'),(35,10,'Los Angeles Clippers','Technology','Technology','Owner'),(36,11,'','Fashion & Retail','Fashion & Retail',''),(37,12,'Alphabet','Technology','Technology','Cofounder and board member'),(38,13,'','Fashion & Retail','Fashion & Retail',''),(39,14,'Alphabet','Technology','Technology','Cofounder and board member'),(40,15,'','Food & Beverage','Food & Beverage',''),(41,16,'Meta Platforms','Technology','Technology','Cofounder'),(42,17,'Koch Industries','Diversified','Diversified','Chairman and CEO'),(43,18,'','Diversified','Diversified',''),(44,19,'Arvest Bank Group','Fashion & Retail','Fashion & Retail','Chairman and CEO'),(45,20,'Walmart','Fashion & Retail','Fashion & Retail','Director'),(46,21,'Crystal Bridges Museum of American Art','Fashion & Retail','Fashion & Retail','Philanthropist'),(47,22,'Thomson Reuters Corporation','Media & Entertainment','Media & Entertainment','Chairman'),(48,23,'Dell Inc','Technology','Technology','Chairman and CEO'),(49,24,'','Diversified','Diversified',''),(50,25,'Nike','Fashion & Retail','Fashion & Retail','Chairman');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_after_creation_location` AFTER INSERT ON `locations` FOR EACH ROW INSERT INTO updated_location VALUES(
	NEW.id,
    NULL,
    NEW.citiCountry,
    NEW.state,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_after_delete_location` AFTER DELETE ON `locations` FOR EACH ROW INSERT INTO updated_location
VALUES 
	(NULL,
    OLD.id, 
	OLD.citiCountry, 
...
INSERT INTO `updated_location` VALUES (50,NULL,'valor',NULL,NULL,NULL,NULL,NULL,'Se ingreso una nueva locacion','2024-01-08 08:52:28','root@localhost'),(51,NULL,'Argentina','Buenos Aires','South','CABA',34.603700,58.381600,'Se ingreso una nueva locacion','2024-01-08 08:38:52','root@localhost'),(52,50,'valor',NULL,NULL,NULL,NULL,NULL,'se elimina una location','2024-01-08 08:39:41','root@localhost'),(53,50,'valor',NULL,NULL,NULL,NULL,NULL,'se elimina una location','2024-01-08 08:52:28','root@localhost');
...
CREATE TABLE `wealths` (
  ...
  KEY `fk_wealth_location` (`ID_location`),
...
-- Dump completed on 2024-01-08  8:59:13
